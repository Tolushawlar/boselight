        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              Fund Your Dreams <span className="text-blue-500">Now</span>
            </h2>
            ...
            <div className="relative">
              ...
              <div className="relative grid grid-cols-3 gap-4 py-8 px-6 text-white">
                <div className="space-y-2">
                  ...
                  <div className="text-sm">Archived Campaigns</div>
                </div>
                <div className="space-y-2">
                  <div className="text-4xl font-bold">1200+</div>
                  <div className="text-sm">Donation Received</div>
                </div>
                <div className="space-y-2">
                  <div className="text-4xl font-bold">545+</div>
                  <div className="text-sm">Clarity in the Last Year</div>
                </div>
              </div>
            </div>
          </motion.div>
